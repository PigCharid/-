...
// File: contracts/interfaces/ISwapTools.sol
...
// File: contracts/pool/Jackpot.sol
...
contract Jackpot is OwnableUpgradeable {
    ...
    function getTickTypeWithTradeAmount(uint256 amount) public view returns(uint tp, uint256 amountUSD) {
        ...
        uint256 value = amount.mul(tokenPrice).div(10**tradeTokenDecimals).div(10**decimals).div(1e12);
