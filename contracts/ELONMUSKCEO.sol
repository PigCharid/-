...
contract ELONMUSKCEO is ERC20, Ownable {
    // 买的手续费
    ...
    constructor() payable ERC20("Elon Musk CEO", "ELONMUSKCEO") {
        // 奖励代币
        rewardToken = 0x846492a296Bb12a5Cd1D17D5D720836DD244bf8a; // USDT
        // 手续费
        burnFeeOnBuy        = 2;
        marketingFeeOnBuy    = 4;
        rewardsFeeOnBuy     = 4;
        ...
        // 市场的钱包地址
        marketingWallet = 0xe600f0b3e494Fe224Da13638174A59750379Eb1e;
        // 创建分红追踪器合约
        dividendTracker = new DividendTracker(420 * 10**5, rewardToken);

        // swap路由
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEb19bACF2DcabAC1F6AC59E778BE0fAEE1d68cFd); // PCS Mainnet
        // 创建交易对
    ...
    function _transfer(
        ...
        // 合约余额大于swapTokensAtAmount才能swap
        bool canSwap = contractTokenBalance >= swapTokensAtAmount;

        // 能够交换  并且 不在swaping 接受代币的地址是交易对  
        // 也就是在卖的时候需要分红
        if( canSwap &&
            !swapping &&
...
// https://bscscan.com/address/0xA37100Bb05271853766af8ed7a32Ca20C8311acc